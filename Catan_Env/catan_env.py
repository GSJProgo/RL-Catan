...
from Catan_Env.board import Board, board
from Catan_Env.board import harbors_building, tiles_buidling, settlements_building, roads_building
from Catan_Env.distribution import  tile_distribution, harbor_distribution, plate_distribution
...
player0_keepresources = player0.Keepresources()
player1_keepresources = player1.Keepresources()

player_keepresources = [player0_keepresources, player1_keepresources]

player0_trading = player0.Trading()
player1_trading = player1.Trading()
