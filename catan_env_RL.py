...
class Player:
    ...
    class Action: 
        def __init__(self):
            ...
            self.yearofplenty_lumber_wool = 0
            self.yearofplenty_lumber_grain = 0
            self.yearofplenty_lumber_brick = 0
            self.yearofplenty_lumber_ore = 0
            
            self.yearofplenty_wool_grain = 0
            self.yearofplenty_wool_brick = 0
            self.yearofplenty_wool_ore = 0
            
            self.yearofplenty_grain_brick = 0
            self.yearofplenty_grain_ore = 0

            self.yearofplenty_brick_ore = 0
        ...
        class KeepRessources:
            def __init__(self):
                ...
                self.keep_2x_wool_2x_lumber = 0
                self.keep_2x_wool_2x_grain = 0
                self.keep_2x_wool_2x_brick = 0
                self.keep_2x_wool_2x_ore = 0
                self.keep_2x_grain_2x_lumber = 0
                self.keep_2x_grain_2x_grain = 0
                self.keep_2x_grain_2x_brick = 0
                self.keep_2x_grain_2x_ore = 0
                self.keep_2x_brick_2x_lumber = 0
                self.keep_2x_brick_2x_wool = 0
                self.keep_2x_brick_2x_grain = 0
                self.keep_2x_brick_2x_ore = 0
                self.keep_2x_ore_2x_lumber = 0
                self.keep_2x_ore_2x_wool = 0
                self.keep_2x_ore_2x_grain = 0
                self.keep_2x_ore_2x_brick = 0
